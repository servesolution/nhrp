...
{
    public class InspectionNewWayService
    {
        ...
        public DataTable InspectionSearchWithPrevGap(InspectionDetailModelClass objInspection, string name, string id, string inspectionLevel, string approve1, string approve2)
        {
            DataTable dt = null;
            DataTable dtbl = null;
            DataTable dtFinal = new DataTable();
        ...
        public DataTable getOwnDetail(string id)
        {
            ...
            try
            {
              ...
              + "IDGN.OWN_DESIGN,NBPD.BANK_CD,NBPD.ACCOUNT_NUMBER ,"
              ...
              + "LEFT OUTER JOIN nhrs_bank_payroll_dtl NBPD ON MOU.NRA_DEFINED_CD=NBPD.NRA_DEFINED_CD "
        ...
        public string saveInspectionInfo(Dictionary<string,MIS.Models.Core.MISCommon.MyValue> lstComply, InspectionDesignModelClass objInspectn)
        {
            ...
            using (ServiceFactory sf = new ServiceFactory())
            {
                ...
                try
                {
                    ...
                    QueryResult qr = sf.SubmitChanges("PR_INSP_PPR_DTL_NEW",
                                              "I",
                                               DBNull.Value,
                                                ...
                                                objInspectn.Bank_ACC_Num,
                                                 objInspectn.Serial_Num.ConvertToString(),
                                                  ...
                                                  InspectionUpdateHistoryId.ToDecimal(),
                                                  objInspectn.PHOTO_7.ToString(),
                                                  objInspectn.PHOTO_8.ToString()
                    );
         ...
         public Boolean saveInspectionDesign(InspectionDesignModelClass ObjDesign)
         {
             ...
             using (ServiceFactory sf = new ServiceFactory())
            {
                ...
                try
                {
                    ...
                    string InspLvl = "select * FROM NHRS_INSPECTION_MST WHERE NRA_DEFINED_CD='" + ObjDesign.NraDefCode.ConvertToString() + "' ";
                    InspLevel = sf.GetDataTable(new
                    {
                        query = InspLvl,
                        args = new { }
                    ...
                    if (InspLevel == null || InspLevel.Rows.Count > 0)
                    {
                        ...
                        ObjDesign.InspectionLevel1 = InspLevel.Rows[0]["INSPECTION_LEVEL1"].ConvertToString();
                        ObjDesign.InspectionLevel2 = InspLevel.Rows[0]["INSPECTION_LEVEL2"].ConvertToString();
                        ObjDesign.InspectionLevel3 = InspLevel.Rows[0]["INSPECTION_LEVEL3"].ConvertToString();
                    }
                    if (ObjDesign.Inspection == "1")
                    {

                        ObjDesign.InspectionLevel1 = "1";
                    }
                    if (ObjDesign.Inspection == "2")
                    {

                        ObjDesign.InspectionLevel2 = "2";
                    }
                    if (ObjDesign.Inspection == "3")
                    {
                        ObjDesign.InspectionLevel3 = "3";
                    }
                    DataTable dtHistory = new DataTable();
                    string inspectionHIstoryId = "";
                    ...
                    if( ObjDesign.Mode=="I")
                    {
                        ...
                        QueryResult qrPaperDtl = sf.SubmitChanges("PR_NHRS_INSPECTION_PAPER_DTL",
                                            ObjDesign.Mode,
                                             DBNull.Value,
                            //objInspectn.InspectionPaperId.ToDecimal(),
                                              DEFINED_CD.ToDecimal(),
                                              ...
                                              ObjDesign.NraDefCode,
                                              ObjDesign.district_Cd.ToDecimal(),
                                              ObjDesign.vdc_mun_cd.ToDecimal(),
                                              ObjDesign.ward_no.ToDecimal(),
                                              MAP_DESIGN.ConvertToString(),
                                              ObjDesign.DesignNumber.ConvertToString(),//design number
                                              RC_MATERIAL_CD.ToDecimal(),
                                              FC_MATERIAL_CD.ToDecimal(),
                                              TECHNICAL_ASSIST.ConvertToString(),
                                              ORGANIZATION_TYPE.ConvertToString(),
                                              ...
                                              SOIL_TYPE.ConvertToString(),
                                              HOUSE_MODEL.ToDecimal(),
                                              ObjDesign.PHOTO_CD_1.ConvertToString(),
                                              ObjDesign.PHOTO_CD_2.ConvertToString(),
                                              ObjDesign.PHOTO_CD_3.ConvertToString(),
                                              ObjDesign.PHOTO_CD_4.ConvertToString(),
                                              ObjDesign.PHOTO_1,
                                              ObjDesign.PHOTO_2,
                                              ObjDesign.PHOTO_3,
                                              ObjDesign.PHOTO_4,
                                              ...
                                              System.DateTime.Now.ConvertToString(),
                                               ...
                                               DBNull.Value,                                //InspectnInstallment
                                               DBNull.Value,                                //MAP_DESIGN_CD
                                               ObjDesign.PHOTO_HOUSE.ConvertToString(),     //Passed_map_no gharko mota moti naksa
                                               DBNull.Value,                          //Others
                                               DBNull.Value,                                //Filebatch

                                              DBNull.Value,                                            //InspectionType
                                              DateTime.Now,                                   //INSPECTION_DATE
                                              ObjDesign.BenfFullNameEng.ConvertToString(),  //BENEFICIARY_NAME
                                              ObjDesign.tole.ConvertToString(),             //TOLE
                                              ObjDesign.KittaNumber.ConvertToString(),      //LAND_PLOT_NUMBER
                                              ObjDesign.ORGANIZATION_OTHERS.ConvertToString(),//ORGANIZATION_OTHERS
                                              ObjDesign.PHOTO_CD_5,
                                              ObjDesign.PHOTO_5.ConvertToString(),
                                              ObjDesign.PHOTO_CD_6,
                                              ObjDesign.PHOTO_6,
                                              ObjDesign.finalDecision.ConvertToString(),//FINAL_DECISION
                                              ObjDesign.LATITUDE.ConvertToString(),
                                              ObjDesign.LONGITUDE.ConvertToString(),
                                              ObjDesign.ATTITUDE.ConvertToString(),
                                              ObjDesign.InspectionMstId.ToDecimal(),
                                              ObjDesign.Bank_Name.ToDecimal(),
                                              ObjDesign.Bank_ACC_Num.ConvertToString(),
                                              ObjDesign.Serial_Num.ConvertToString(),
                                              ObjDesign.hOwnerId.ConvertToString(),
                                              ObjDesign.MobileNumber.ConvertToString(),
                                              ObjDesign.form_pad_number.ConvertToString(),    //FORM_PAD_NUMBER
                                                ObjDesign.design_detail.ConvertToString(),   //DESIGN_DETAILS
                                                ObjDesign.edit_required.ConvertToString(),    //EDIT_REQUIRED
                                                ObjDesign.edit_required_detail.ConvertToString(),    //EDIT_REQUIRED_DETAILS
                                                ObjDesign.bank_select.ConvertToString(),    // BANK_SELECT
                                                ObjDesign.bank_branch.ToDecimal(),         //BANK_BRANCH
                                                ObjDesign.Final_Remarks.ConvertToString(),     // FINAL_REMARKS
                                                ObjDesign.accept_the_entry.ConvertToString(),    //ACCEPT_THE_ENTRY
                                                ObjDesign.gps_taken.ConvertToString(),   //GPS_TAKEN
                                                ObjDesign.finalDecision2.ConvertToString(),    //FINAL_DECISION_2
                                                ObjDesign.bank_not_available_remarks.ConvertToString(),  //BANK_NOT_AVAILABLE_REMARKS
                                                "N",                            //FINAL DECISION APPROVE 
                                                "N",                            // FIANL DECISION APPROVE 2
                                                ObjDesign.approve_batch.ToDecimal(),
                                                ObjDesign.approve_batch_2.ToDecimal(),
                                                ObjDesign.Inspection.ConvertToString(),
                                                 inspectionHIstoryId.ToDecimal());

                        //Main Table 
                        InspectionPaperId = qrPaperDtl["v_INSPECTION_PAPER_ID"].ConvertToString();
                        
                       var qre = sf.SubmitChanges("PR_NHRS_INSPECTION_PROCESS_DTL",
                                          ObjDesign.Mode,

                                           DBNull.Value,
                                           DBNull.Value,
                                           ObjDesign.BeneficiaryFullName.ConvertToString(),
                                           ObjDesign.BenfRelation.ConvertToString(),

                                           ObjDesign.SuprtntfFullnameEng.ConvertToString(),
                                            ObjDesign.SupertntDesignation.ConvertToString(),

                                           ObjDesign.EngineerFullname.ConvertToString(),
                                           ObjDesign.EngineerDesignation.ConvertToString(),

                                           ObjDesign.BenfSignDateLoc.ConvertToString("YYYY-MM-DD"),
                                           ObjDesign.SupertntSignDateLoc.ConvertToString("YYYY-MM-DD"),
                                           ObjDesign.EngineerSignDateLoc.ConvertToString("YYYY-MM-DD"),
                                           "Registered",
                    ...
                    if(ObjDesign.Mode=="U")
                    {
                        ...
                        cmdHistoryid = " SELECT (NVL(MAX(INSPECTION_HISTORY_ID), 0) + 1) AS  INSPECTION_HISTORY_ID  FROM NHRS_INSPECTION_UPDATE_HISTORY";
                        dtHistory = sf.GetDataTable(new
                        {
                            query = cmdHistoryid,
                            args = new { }
                        ...
                        insertCmd = "INSERT INTO NHRS_INSPECTION_UPDATE_HISTORY (INSPECTION_HISTORY_ID) VALUES ('" + InspectionHistoryId + "')";
                        InsertHistoryId = sf.SubmitChanges(insertCmd,null);
          ...
          public InspectionDesignModelClass getAllInnfoForInspection1(string nraDefCode, string owndesign,string DesignId)
          {
                ...
                try
                {
                    if (owndesign=="Y")
                    {
                        cmdtext = "SELECT NIM.INSPECTION_MST_ID, NIM.INSPECTION_STATUS,NIM.INSPECTION_LEVEL0, NIM.INSPECTION_LEVEL1, NIM.INSPECTION_LEVEL2, NIM.INSPECTION_LEVEL3,"
                           ...
                           + "NIPD.PHOTO_CD_3, NIPD.PHOTO_CD_4,NIPD.PHOTO_CD_5, NIPD.PHOTO_CD_6, NIPD.PHOTO_1,NIPD.PHOTO_2, NIPD.PHOTO_3, NIPD.PHOTO_4, NIPD.PHOTO_5,NIPD.PHOTO_6,NIPD.PHOTO_7,NIPD.PHOTO_8,"
              ...
              if(dt!=null&&dt.Rows.Count>0)
              {
                  foreach(DataRow dr in dt.Rows)
                  {
                              ...
                              objInspDesign.PHOTO_7 = dr["PHOTO_7"].ConvertToString();
                              objInspDesign.PHOTO_8 = dr["PHOTO_8"].ConvertToString();
        ...
        public string getDesignByMaterialID(string constructMatID, string roofMatID)
        {
            ...
            try
            {
                ...
                if (constructMatID != "")
                {
                    cmd = "SELECT HOUSE_MODEL_CD from NHRS_INSPECTION_MDL_MAPPING WHERE CONSTRUCTION_MAT_CD = '" + constructMatID + "' ";
                }
                //if (roofMatID != "")
                //{
        ...
        public bool saveInspectionPhotoOnly(InspectionDesignModelClass objModel)
        {
            object enteredBy = null;
            object enteredDt = null;
            object updatedBy = null;
            object updatedDt = null;
            if(objModel.Mode=="I")
            {
                enteredBy =  SessionCheck.getSessionUsername();
                enteredDt = DateTime.Now;
            }
            else
            {
                updatedBy = SessionCheck.getSessionUsername();
            ...
            using(ServiceFactory sf = new ServiceFactory())
            {
                    try
                    {
                        ...
                        qr = sf.SubmitChanges("PR_UPLOAD_INSP_PHOTO_NME",
                            objModel.Mode.ConvertToString(),
                           objModel.PHOTO_ID.ToDecimal(),  //photo id 
                            objModel.NraDefCode.ConvertToString(),
                            objModel.Inspection.ToDecimal(),
                            objModel.Serial_Num.ConvertToString(),
                            objModel.PHOTO_1.ConvertToString(),
                            objModel.PHOTO_2.ConvertToString(),
                            objModel.PHOTO_3.ConvertToString(),
                            objModel.PHOTO_4.ConvertToString(),
                            objModel.PHOTO_5.ConvertToString(),
                            objModel.PHOTO_6.ConvertToString(),
                            objModel.PHOTO_7.ConvertToString(),
                            objModel.PHOTO_8.ConvertToString() ,
                            DBNull.Value,//status,
                            SessionCheck.getSessionUsername(),
                            DateTime.Now,
                            enteredBy,
        ...
        public string CheckIfMoudApprove(string pa, string Level)
        {
            ...
            try
            {
                if(Level=="1")
                {
                    cmd = "SELECT INSP_ONE_MOUD_APPROVE AS APPROVED_F FROM NHRS_INSPECTION_MST WHERE NRA_DEFINED_CD ='" + pa + "'";
                   
                }
                if (Level == "2")
                {
                    cmd = "SELECT INSP_TWO_MOUD_APPROVE AS APPROVED_F FROM NHRS_INSPECTION_MST WHERE NRA_DEFINED_CD ='" + pa + "'";

                }
                if (Level == "3")
                {
                    cmd = "SELECT INSP_THREE_MOUD_APPROVE AS APPROVED_F FROM NHRS_INSPECTION_MST WHERE NRA_DEFINED_CD ='" + pa + "'";
            ...
            if(dtbl!=null && dtbl.Rows.Count>0)
            {
                if(dtbl.Rows[0]["APPROVED_F"].ConvertToString()=="Y")
                {
                    result = "Y";
                }
                else
        ...
        public DataTable GetBeneficiary(string distCd, string PaNumber)
        {
            ...
            try
            {
                if (distCd != null)
                {
                    cmd = "SELECT NRA_DEFINED_CD   FROM NHRS_ENROLLMENT_MST WHERE NRA_DEFINED_CD ='" + PaNumber + "' AND DISTRICT_CD='" + distCd + "'";
                   
                }
                else
                {
                    cmd = "SELECT NRA_DEFINED_CD   FROM NHRS_ENROLLMENT_MST WHERE NRA_DEFINED_CD ='" + PaNumber + "' ";
