...
{
    public class InspectionUpdateJsonService
    {

        public bool UpdateInspectionData(List<SortedDictionary<dynamic, dynamic>> InspectionInfo, string filename)
        {
                ...
                using (ServiceFactory service = new ServiceFactory())
                {
                    try
                    {
                     ...
                     //   InspectionMstId = qrMst["v_INSPECTION_MST_ID"].ConvertToString();
                        ...
                        //for inspection detail history
                        DataTable dtPaperId = new DataTable();
                        string cmdTextUpdate = "select INSPECTION_PAPER_ID from NHRS_INSPECTION_PAPER_DTL WHERE INSPECTION_LEVEL='" + inspectionLevel.ConvertToString() + "' AND NRA_DEFINED_CD='"  + objDesign.NRA_DEFINED_CD.ConvertToString() + "'";
