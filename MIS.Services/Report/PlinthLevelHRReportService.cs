...
{
    public class PlinthLevelHRReportService
    {
        public DataTable GetPlinthLevelHRReport(NameValueCollection paramValues)
        {
            DataTable dt = null;
            ...
            using (ServiceFactory service = new ServiceFactory())
            {
                ...
                {
                    service.Begin();
                    dt = service.GetDataTable(true, "GR_HR_PLINTH_LEVEL_REPORT",
