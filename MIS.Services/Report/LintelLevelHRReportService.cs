...
{
    public class LintelLevelHRReportService
    {
        public DataTable GetLintelLevelHRReport(NameValueCollection paramValues)
        {
            DataTable dt = null;
            ...
            using (ServiceFactory service = new ServiceFactory())
            {
                ...
                {
                    service.Begin();
                    dt = service.GetDataTable(true, "GR_HR_LINTEL_LEVEL_REPORT",
