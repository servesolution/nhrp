...
{
    public class GrievanceProgressHRReportService
    {
        public DataTable GetGrievanceProgressHRReport(NameValueCollection paramValues)
        {
            DataTable dt = null;
            ...
            using (ServiceFactory service = new ServiceFactory())
            {
                ...
                {
                    service.Begin();
                    dt = service.GetDataTable(true, "GR_HR_GRIEVANCE_PROGRESS_RPT",
