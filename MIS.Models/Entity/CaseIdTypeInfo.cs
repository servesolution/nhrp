...
[Table(Name = "CASE_ID_TYPE")]
public class CaseIdTypeInfo : EntityBase
{
	private Decimal? idTypeCd  = 0;
	...
	[Column(Name = "ID_TYPE_CD", IsKey = true, SequenceName = "")]
	public Decimal? IdTypeCd
	{
		get{return idTypeCd;}
		set{idTypeCd = value;}
	}
