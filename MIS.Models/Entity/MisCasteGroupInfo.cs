...
[Table(Name = "MIS_CASTE_GROUP")]
public class MisCasteGroupInfo : EntityBase
{
	private Decimal casteGroupCd  = 0;
	...
	[Column(Name = "CASTE_GROUP_CD", IsKey = true, SequenceName = "")]
