...
[Table(Name = "CASE_REGISTRATION_TYPE")]
public class CaseRegistrationTypeInfo : EntityBase
{
	private Decimal? regTypeCd  = 0;
	...
	[Column(Name = "REG_TYPE_CD", IsKey = true, SequenceName = "")]
	public Decimal? RegTypeCd
	{
		get{return regTypeCd;}
		set{regTypeCd = value;}
	}
	...
	public CaseRegistrationTypeInfo()
	{}
