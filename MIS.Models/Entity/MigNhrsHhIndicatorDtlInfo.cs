...
[Table(Name = "MIG_NHRS_HH_INDICATOR_DTL")]
public class MigNhrsHhIndicatorDtlInfo : EntityBase
{
	...
	private System.String indicatorBefore = null;

	private System.String indicatorAfter = null;
	...
	[Column(Name = "INDICATOR_BEFORE", IsKey = false, SequenceName = "")]
	public System.String IndicatorBefore 
	{ 
		get{return indicatorBefore;}
		set{indicatorBefore = value;} 
	}

	[Column(Name = "INDICATOR_AFTER", IsKey = false, SequenceName = "")]
	public System.String IndicatorAfter 
	{ 
		get{return indicatorAfter;}
		set{indicatorAfter = value;} 
	}
	...
	public MigNhrsHhIndicatorDtlInfo()
	{}
}